import { BatchskuentryComponent } from './../../../_components/manualentry/batchskuentry/batchskuentry.component';
import { RejectreworkComponent } from './../../../_components/manualentry/rejectrework/rejectrework.component';
...
export class SfwLayoutComponent implements OnInit, AfterViewInit {
  ...
  displayData = { Shift: 'Shift A', Period: '-', User: 'User' };
  ...
  ngOnInit(): void {
    ...
    this.httpClient.get(this.clientService.apiConfigs.dashboardAPI + '/api/shift/shift/all?line_id=5f0809fdc2b1ce30cc53eb8d').subscribe((shiftData: any) => {
      ...
      this.headerInfo.operatorName = shiftData[0].operator_name && shiftData[0].operator_name.display_name ? shiftData[0].operator_name.display_name : '';
      this.headerInfo.skuName = shiftData[0].sku;
